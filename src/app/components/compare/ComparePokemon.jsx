				...
				return (
					<div
						...
						<div
                            ...
                            from-poke-yellow hover:from-poke-blue to-neutral-950 border-2
                            border-poke-yellow rounded-t transition-all ease-in-out duration-500 h-full'
							style={{
								width: pokemon2
									? `${width1}%`
									: `${stat1.base_stat * 2.5}%`,
						...
						{pokemon2 && (
							<div
								className='flex justify-between items-center font-stats font-bold 
                                           ...
                                           to-neutral-950 border-2 border-poke-blue
                                           rounded-t transition-all ease-in-out
                                           duration-500 h-full'
								style={{ width: `${width2}%` }}>
